...
const VisualStories = ({ isCollapsed }) => {
  const handleButtonClick = () => {
    console.log('Button clicked');
  };

  const columnLabels = ['', 'S.No', 'Category Name', 'Story Title', 'Category Type', 'Manage/Add Sub Story', 'Date', 'View', 'Action'];

  const [rows, setRows] = useState([{ id: 1, data: Array(8).fill('') }]);
  ...
  return (
    <>
      <div className={`container-fluid visual-stories-container ${isCollapsed ? 'content-moved-11' : ''}`}>
        <div className="row">
          <div className="col">
            <p>Visual Stories</p>
          </div>
          <div className="col d-flex justify-content-end">
            <Link to="/visualstorypage">
        ...
        <div className="container-fluid vh-100 all-post-container ">
          ...
          <div className="inside-visual-stories-container">
